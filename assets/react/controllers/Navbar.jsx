                  ...
                  {isLoggedIn ? (
                    ...
                    <>
                      <div>
                        <a
                          href="/login"
                          className="flex items-center text-white group hover:bg-red-800 rounded-md px-3 py-2 text-sm font-medium group"
                        >
                          <UserIcon
                            className="h-6 w-6 text-white bg-red-700 rounded-full group-hover:bg-red-800 group-hover:text-white"
                            aria-hidden="true"
                          />
                          <span className="ml-2 group-hover:text-white">Se connecter</span>
                        </a>
                      </div>
                    </>
                  )}
